...
export default function SerialKeysAdminPage() {
    ...
    return ( <
        ...
        형식은 XXXX - XXXX - XXXX - XXXX이며, 영어 대문자· 소문자· 숫자로 생성됩니다.발급 시 중복 검사를 수행합니다. <
        /p>
        ...
        onChange = {
            (event) => setDurationDays(event.target.value)
        }
        style = {
            inputStyle
        } >
